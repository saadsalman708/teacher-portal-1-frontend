  ...
  if (loading && students.length === 0) {
    return (
      <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center">
        ...
        <p className="text-xl animate-pulse text-gray-400">
    ...
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-gray-800 p-6 rounded-2xl shadow-xl border border-gray-700 flex flex-col md:flex-row justify-between items-start md:items-center">
          ...
          <button
            onClick={logOut}
            className="mt-4 md:mt-0 px-6 py-2 bg-red-600 hover:bg-red-700 rounded-md text-sm font-medium transition-colors shadow-md"
          >
            Logout
          </button>
        </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div>
                ...
                <input
                  type="text"
                  required
                  className="w-full p-2 bg-gray-900 border border-gray-600 rounded text-gray-200 focus:outline-none focus:border-blue-500"
                  value={form.name}
              ...
              {students.length === 0 ? (
                ...
                <ul className="divide-y divide-gray-700 flex-1">
                  {students.map((student) => (
                    <li
                      key={student._id}
                      className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-4 hover:bg-gray-800/50 transition-colors"
                    >
                      ...
                      <div className="flex gap-2 mt-3 sm:mt-0">
                        <button
                          ...
                          className="bg-gray-700 hover:bg-blue-600 text-white px-4 py-1.5 rounded text-sm transition-colors"
                        >
                          Edit
                        </button>
                        <button
                          onClick={() => handleDelete(student._id)}
                          className="bg-gray-700 hover:bg-red-600 text-white px-4 py-1.5 rounded text-sm transition-colors"
                        >
                          Delete
                        </button>
                      </div>
              ...
              {totalPages > 1 && (
                <div className="bg-gray-800/50 border-t border-gray-700 p-4 flex justify-between items-center text-sm">
                  <button
                    ...
                    className="px-4 py-2 rounded bg-gray-700 text-gray-200 disabled:opacity-50 hover:bg-gray-600"
                  >
                    Previous
                  </button>
